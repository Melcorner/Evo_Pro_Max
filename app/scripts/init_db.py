...
def init_db():
    ...
    cur.execute(
        ...
        CREATE TABLE IF NOT EXISTS tenants (
            ...
            ms_store_id         TEXT,
            ms_agent_id         TEXT,
              sale_document_mode TEXT DEFAULT 'demand',
              ms_retail_store_id TEXT,
              ms_retail_shift_id TEXT,
              ms_cashier_id TEXT,
    ...
    migrations = [
        ...
        ("tenant_stores", "sale_document_mode", "TEXT DEFAULT 'demand'"),
        ("tenant_stores", "ms_retail_store_id", "TEXT"),
        ("tenant_stores", "ms_retail_shift_id", "TEXT"),
        ("tenant_stores", "ms_cashier_id", "TEXT"),
